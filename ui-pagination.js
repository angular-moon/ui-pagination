...
angular.module("ui.pagination.tpls", []).run([
  "$templateCache",
  function ($templateCache) {
    $templateCache.put(
      "template/originPagination/pager.html",
      '<ul class="pager">\n' +
        '  <li ng-class="{disabled: noPrevious(), previous: align}"><a href ng-click="selectPage(page - 1, $event)">{{getText(\'previous\')}}</a></li>\n' +
        "  <li style='display: inline-block;padding: 5px 0;'>{{page + '/' + getNumPages(totalItems / itemsPerPage)}}</li>\n" +
        '  <li ng-class="{disabled: noNext(), next: align}"><a href ng-click="selectPage(page + 1, $event)">{{getText(\'next\')}}</a></li>\n' +
        "</ul>"
    );
    $templateCache.put(
      "template/originPagination/pagination.html",
      '<ul class="pagination">\n' +
...
angular
  .module("ui.pagination", ["ui.pagination.tpls"])
  ...
  .directive("uiPagination", function () {
    return {
      ...
      replace: true,
      template:
        '<div class="clearfix pagination-wrap" ng-hide="hideOnSinglePage && totalItems<=itemsPerPage">' +
        '<div class="pagination info">{{title}}共 <span style="color:#ac2925">{{totalItems}}</span> 条 ' +
  ...
  .directive("originPagination", [
    "$parse",
    "originPaginationConfig",
    ...
    function (pagerConfig) {
      return {
        ...
        link: function (scope, element, attrs, ctrls) {
          ...
          scope.getNumPages = function (input) {
